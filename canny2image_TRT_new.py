...
class hackathon():
    ...
    def initialize(self):
        ...
        self.model.load_state_dict(load_state_dict(f'{prefix}/ControlNet/models/control_sd15_canny.pth', location='cuda'))
        ...
        # [print(x) for x in dir(self.model)]
        # print('!!!!!!!!!!!!!!!!!!!!!!!!!')
